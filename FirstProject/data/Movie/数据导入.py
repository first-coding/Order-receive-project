...
def import_data(df,passward,database_name):
    # 连接MySQL数据库
...
if __name__ == '__main__':
    ...
    print('创建成功')
    df = pd.read_excel(r"D:\Order receiving item\FirstProject\data\Movie\movie_data.xlsx",engine='openpyxl');
    import_data(df,passward=password,database_name=database_name)
    print('导入成功')
    time.sleep(3)